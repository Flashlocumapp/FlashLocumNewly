...
export default function DoctorPersonalDataScreen() {
  ...
  const handleDeleteAccount = () => {
    console.log('[Doctor Personal Data] Delete Account pressed');
    setShowDeleteModal(true);
  };

  const handleConfirmDelete = async () => {
    console.log('[Doctor Personal Data] Confirm delete account');
    setDeleting(true);
    ...
    <>
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        <TouchableOpacity
          ...
          onPress={() => {
            console.log('[Doctor Personal Data] Back pressed');
            router.back();
          }}
          activeOpacity={0.7}
      ...
      <DeleteAccountModal
        ...
        onCancel={() => {
          console.log('[Doctor Personal Data] Delete modal cancelled');
          setShowDeleteModal(false);
        }}
