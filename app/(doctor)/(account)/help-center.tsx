      ...
      body: () => (
        <View>
          ...
          <Text style={styles.bodyText}>
            FlashLocum charges a 10% platform fee on each completed shift. You receive 90% of the total shift amount.
          </Text>
          <Text style={[styles.bodyText, { marginTop: 8 }]}>
            For example, if a completed shift is worth ₦20,000, the platform fee is ₦2,000 and your earnings are ₦18,000.
          </Text>
          <Text style={[styles.bodyText, { marginTop: 8 }]}>
