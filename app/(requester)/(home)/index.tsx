...
export default function RequesterHomeScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {/* ══════════════════════════════════════════════════════════════════════════
          IDLE STATE — split column: map fills remaining space, white section below
      ══════════════════════════════════════════════════════════════════════════ */}
      {sheetState === 'idle' && (
      ...
      {/* ══════════════════════════════════════════════════════════════════════════
          NON-IDLE STATES — full-screen map + absolute animated sheet
      ══════════════════════════════════════════════════════════════════════════ */}
      {sheetState !== 'idle' && (
        <View style={{ flex: 1 }}>
          {/* Map wrapped in TouchableWithoutFeedback for tap-to-dismiss */}
