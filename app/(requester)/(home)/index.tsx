...
const MINIMALIST_MAP_STYLE = [
  ...
  { featureType: 'road', elementType: 'geometry.fill', stylers: [{ color: '#B0B8C1' }] },
  { featureType: 'road', elementType: 'labels', stylers: [{ visibility: 'off' }] },
  { featureType: 'road', elementType: 'labels.icon', stylers: [{ visibility: 'off' }] },
  { featureType: 'road.arterial', elementType: 'geometry', stylers: [{ color: '#A0AAB4' }] },
  { featureType: 'road.highway', elementType: 'geometry', stylers: [{ color: '#8A96A3' }] },
  { featureType: 'road.highway.controlled_access', elementType: 'geometry', stylers: [{ color: '#7A8694' }] },
